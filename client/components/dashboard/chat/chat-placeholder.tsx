...
export function ChatPlaceholder({ onSelectDocument }: ChatPlaceholderProps) {
  ...
  return (
    <>
      <div className="h-full w-full overflow-y-auto flex flex-col bg-linear-to-br from-slate-50 via-white to-rose-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-rose-950/10 transition-colors">
        
        <div className="flex-1 min-h-12 shrink-0"></div>

        <div className="max-w-2xl w-full mx-auto px-6 space-y-8 shrink-0 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="pt-4">
            {loading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
                  {documents.slice(0, 4).map((doc, index) => (
                    <button
                      ...
                      className="group p-4 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-rose-300 dark:hover:border-rose-700 hover:shadow-lg hover:shadow-rose-500/10 transition-all duration-300 text-left hover:scale-[1.02] active:scale-[0.98] w-full"
                      style={{
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="shrink-0 p-2 bg-rose-50 dark:bg-rose-900/30 rounded-lg group-hover:bg-rose-100 dark:group-hover:bg-rose-900/50 transition-all duration-300 group-hover:scale-110">
                        ...
                        <Icons.arrowRight className="shrink-0 w-4 h-4 text-slate-400 group-hover:text-rose-600 dark:group-hover:text-rose-400 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-1" />
                      </div>
                    </button>
                  ))}
                </div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 text-center animate-in fade-in duration-500 delay-300 pt-4">
