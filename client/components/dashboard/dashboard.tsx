        ...
        <>
          <div className="flex h-[calc(100vh-70px)] w-full bg-slate-50 dark:bg-slate-900/50">
            ...
            <main className="flex-1 flex flex-col h-full relative overflow-hidden transition-all">
              {/* MOBILE HEADER */}
              <div className="lg:hidden flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-800 dark:bg-slate-950 z-10">
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <SheetContent
                      side="left"
                      className="p-0 w-80 border-r dark:bg-slate-900 border-slate-200 dark:border-slate-800 bg-slate-50"
                    >
